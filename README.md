...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=coverage)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=bugs)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=mariapanas_ReengineeringLabs&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=mariapanas_ReengineeringLabs)
